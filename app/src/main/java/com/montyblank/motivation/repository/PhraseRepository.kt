...
class PhraseRepository {
    ...
    private val listPhrases: List<Phrase> = listOf(
        ...
        Phrase("Not knowing it was impossible, he went there and did it.",
            happy,
            langEn
        ),
        Phrase(
        ...
        Phrase(
            "If you don't know where you want to go, any way will do.",
            sunny,
            langEn
        ),
        Phrase(
        ...
        Phrase(
            "Ne sachant pas que c'était impossible, il y est allé et l'a fait.",
            happy,
            langFr),
        Phrase(
        ...
        Phrase(
            "Ne t'arrête pas quand tu es fatigué, arrête quand tu as fini.",
            happy,
            langFr
        ),
        Phrase(
        ...
        Phrase(
            "Vous perdez toutes les chances que vous ne prenez pas.",
            sunny,
            langFr
        ),
        Phrase(
            "L'échec est l'épice qui parfume le succès.",
            sunny,
            langFr
        ),
        Phrase(
            "Tant qu'on n'est pas engagé, il y aura des hésitations!",
            sunny,
            langFr
        ),
        Phrase(
        ...
        Phrase(
            "Si vous croyez, cela fait toute la différence.",
            sunny,
            langFr
        ),
        Phrase(
